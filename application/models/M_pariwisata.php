<?php 
    ...
    class M_employee extends CI_Model {
        ...
        // get employee
        function getDataPariwisata( $key = null) {

            if ( $key ) {

                $query = $this->db->get_where('V_pariwisata', $key);
            } else $query = $this->db->get('V_pariwisata');
        ...
        function onUpdateEmployee(){
            ...
            $data = array(
                ...
                'description_spot'=> $this->input->post('description_spot'),
                'photo_spot' => $this->input->post('photo_spot'),
                'caption_spot'      => $this->input->post('caption_spot'),
                'status_spot'=> $this->input->post('status_spot'),
