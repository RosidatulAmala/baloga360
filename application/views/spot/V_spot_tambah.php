									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Spot Baloga</a>
											</li>
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Tambah Spot Baloga Baru</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							<!--begin::Container-->
							<div class="container">
								<form action="<?php echo base_url('spot/prosestambah') ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="col-md-7">
										...
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">Form Tambah Spot Baloga 360</h3>
											...
											<form class="form">
												<div class="card-body">
													<div class="form-group">
														...
														<input type="text" name="nama_spot" class="form-control" placeholder="Masukkan nama spot atau area baloga . . ." required="" />
														<span class="form-text text-muted">Berisi nama spot baloga</span>
													</div>
													<div class="form-group">
														<label>Deskripsi:</label>
														<textarea name="deskripsi" class="form-control" rows="10" placeholder="Masukkan deskripsi apabila diperlukan"></textarea>
