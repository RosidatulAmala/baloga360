								...
								<div class="d-flex align-items-center mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Sunting Scene Baloga</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
                            ...
                            <form action="<?php echo base_url('scene/update/'. $scene['info_scene']['id_scene_info']) ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="col-md-8">
										...
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">Form Sunting Scene Baloga 360</h3>
											...
											<div class="form">
												<div class="card-body">
													<div class="form-group">
														<label>Author:</label>
														<input type="text" name="author" value="<?php echo $scene['info_scene']['author'] ?>" class="form-control" placeholder="Masukkan nama author atau sub-baloga . . ." required="" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="rotation" value="<?php echo $scene['info_scene']['scene_rotate'] ?>" class="form-control" placeholder="Masukkan jumlah rotasi 360 . . ." required="" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="fade" value="<?php echo $scene['info_scene']['scene_fade_duration'] ?>" class="form-control" placeholder="Masukkan Durasi m/s . . ." required="" />
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="form-group">
																...
																<div class="radio-inline">
																	<label class="radio">
																	<input type="radio" name="autoload" value="true" <?php if ($scene['info_scene']['scene_autoload'] == "true") { echo 'checked'; } ?> required=""/>
																	<span></span>True</label>
																	<label class="radio">
																	<input type="radio" name="autoload" value="false" <?php if ($scene['info_scene']['scene_autoload'] == "false") { echo 'checked'; } ?> required=""/>
													...
													<div class="row">
														...
														<div class="col-md-5">
															<div class="form-group">
																...
																<div class="radio-inline">
																	<label class="radio">
																	<input type="radio" name="status" value="aktif" <?php if ($scene['info_scene']['scene_status'] == "aktif") { echo 'checked'; } ?> required=""/>
																	<span></span>Ditampilkan</label>
																	<label class="radio">
																	<input type="radio" name="status" value="nonaktif" <?php if ($scene['info_scene']['scene_status'] == "nonaktif") { echo 'checked'; } ?> required=""/>
