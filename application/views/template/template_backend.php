...
<head>
    ...
    <!-- Tema -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/themes/theme-prickly-pear.min.css') ?>">
...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <?php $this->load->view( $nama_folder.'/'. $namadalamview ) ?>
            ...
            <nav id="mainnav-container">
                <div id="mainnav">
                    ...
                    <!--It will only appeargr  on small screen devices.-->
                    <!--================================
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        ...
                                        <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                            ...
                                            <p class="mnp-name">Rosidatul Amala</p>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li>
						                ...
						                <!--Submenu-->
						                <ul class="collapse">
						                    <li><a href="<?php echo base_url('about/index') ?>">Tentang Kami</a></li>
											<li><a href="ui-panels.html">Kontak Kami</a></li>
                                    ...
                                    <li>
						                ...
						                <!--Submenu-->
						                <ul class="collapse">
						                    <li><a href="ui-buttons.html">Tentang Kami</a></li>
											<li><a href="ui-panels.html">Kontak Kami</a></li>
                                    ...
                                    <!--Submenu-->
						                <ul class="collapse">
						                    <li><a href="<?php echo base_url ('pengguna/viewBiodata') ?>">Biodata Pengguna</a></li>
											<li><a href="ui-panels.html">Kontak Kami</a></li>
						                </a>
